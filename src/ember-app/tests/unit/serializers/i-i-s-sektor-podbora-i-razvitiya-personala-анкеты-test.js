...
moduleForModel('i-i-s-sektor-podbora-i-razvitiya-personala-анкеты', 'Unit | Serializer | i-i-s-sektor-podbora-i-razvitiya-personala-анкеты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-sektor-podbora-i-razvitiya-personala-анкеты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
