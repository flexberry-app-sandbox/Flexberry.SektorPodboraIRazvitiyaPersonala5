...
moduleForAcceptance('[AGAT] Acceptance | i i s sektor podbora i razvitiya personala анкеты l');

test('testing i-i-s-sektor-podbora-i-razvitiya-personala-анкеты-l', function(assert) {
