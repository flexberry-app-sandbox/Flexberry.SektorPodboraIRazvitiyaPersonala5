...
moduleForAcceptance('[AGAT] Acceptance | i i s sektor podbora i razvitiya personala прич увол и реком l');

test('testing i-i-s-sektor-podbora-i-razvitiya-personala-прич-увол-и-реком-l', function(assert) {
