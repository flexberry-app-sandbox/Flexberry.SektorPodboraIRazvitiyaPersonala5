...
moduleForAcceptance('[AGAT] Acceptance | i i s sektor podbora i razvitiya personala инф из анкет l');

test('testing i-i-s-sektor-podbora-i-razvitiya-personala-инф-из-анкет-l', function(assert) {
